...
namespace HypestoreFinal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email,Full_Name=model.FirstName,PhoneNumber=model.phone };
   ...
   var isSave = cb.add(customer);
        ...
        public async Task<ActionResult> RegisterCustomer(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Full_Name = model.FirstName + " " + model.LastName, PhoneNumber = model.phone,   EmailConfirmed = true };
